...
class Qwen2VLGRPOTrainer(Trainer):
    ...
    def _get_per_token_logps(self, model, input_ids, attention_mask, pixel_values, image_grid_thw):
        ...
        # pixel_values = pixel_values.view(batch_size, -1, pixel_values.shape[-1])
        # # print(f'pixel_values (grpo): {pixel_values.shape}')
        # # print(f'image_grid_thw: {image_grid_thw.shape}')
        # for i, a, p, g in zip(input_ids, attention_mask, pixel_values, image_grid_thw):
        #     l = model(i.unsqueeze(0), attention_mask=a.unsqueeze(0), pixel_values=p.unsqueeze(0), image_grid_thw=g.unsqueeze(0)).logits
        #     print(l.shape)
        #     logits.append(l)
